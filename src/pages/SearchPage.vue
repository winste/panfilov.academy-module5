...
import VSearchCardsSection from '@/components/searchPage/VSearchCardsSection.vue'
import VSearchMapSection from '@/components/searchPage/VSearchMapSection.vue'
